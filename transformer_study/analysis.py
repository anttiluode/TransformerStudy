...
__all__ = [
    ...
    "analyze_correct_conditioned", "analyze_translation_controls", "analyze_composition_controls",
]

from .gate1_analysis import analyze_composition_controls, analyze_correct_conditioned, analyze_translation_controls
